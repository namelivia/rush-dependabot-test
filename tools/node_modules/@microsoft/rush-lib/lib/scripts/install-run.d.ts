...
export declare function installAndRun(logger: ILogger, packageName: string, packageVersion: string, packageBinName: string, packageBinArgs: string[]): number;
export declare function runWithErrorAndStatusCode(logger: ILogger, fn: () => number): void;
