...
class VersionManager {
    ...
    async bumpAsync(lockStepVersionPolicyName, bumpType, identifier, shouldCommit) {
        ...
        const changeManager = new ChangeManager_1.ChangeManager(this._rushConfiguration, this._getManuallyVersionedProjects());
    ...
    _getManuallyVersionedProjects() {
        ...
        this._versionPolicyConfiguration.versionPolicies.forEach((versionPolicy) => {
            if (versionPolicy instanceof VersionPolicy_1.LockStepVersionPolicy && versionPolicy.nextBump !== undefined) {
    ...
    _updateVersionsByPolicy(versionPolicyName, force) {
        ...
        this._rushConfiguration.projects.forEach((rushProject) => {
            ...
            if (projectVersionPolicyName &&
                ...
                const oldVersion = ((_a = this._updatedProjects.get(rushProject.packageName)) === null || _a === void 0 ? void 0 : _a.version) || rushProject.packageJson.version;
