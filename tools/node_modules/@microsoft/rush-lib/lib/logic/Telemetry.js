...
class Telemetry {
    ...
    log(telemetryData) {
        ...
        const data = Object.assign(Object.assign({}, telemetryData), { timestamp: telemetryData.timestamp || new Date().getTime(), platform: telemetryData.platform || process.platform, rushVersion: telemetryData.rushVersion || Rush_1.Rush.version });
