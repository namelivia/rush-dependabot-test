...
const DependencyAnalyzerModule = node_core_library_1.Import.lazy('../logic/DependencyAnalyzer', require);
...
class RushConfiguration {
    ...
    _initializeAndValidateLocalProjects() {
        ...
        const allowedProjectTags = this._rushConfigurationJson.allowedProjectTags
