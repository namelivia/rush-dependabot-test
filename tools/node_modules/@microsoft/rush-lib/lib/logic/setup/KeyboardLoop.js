    ...
    _checkForTTY() {
        ...
        if (process.platform === 'win32') {
            ...
            if (shell.toUpperCase().endsWith('BASH.EXE')) {
                ...
                console.error(safe_1.default.red('ERROR: It appears that Rush was invoked from Git Bash shell, which does not support the\n' +
        ...
        console.error(safe_1.default.red('ERROR: Rush was invoked by a command whose STDIN does not support the TTY mode for\n' +
