...
class TarExecutable {
    ...
    static async tryInitializeAsync(terminal) {
        ...
        const tarExecutablePath = EnvironmentConfiguration_1.EnvironmentConfiguration.tarBinaryPath || (await TarExecutable._tryFindTarExecutablePathAsync());
    ...
    static async _tryFindTarExecutablePathAsync() {
        if (os_1.default.platform() === 'win32') {
            ...
            if (windowsFolderPath) {
                ...
                if (await node_core_library_1.FileSystem.existsAsync(defaultWindowsTarExecutablePath)) {
                    return defaultWindowsTarExecutablePath;
                }
            }
        }
        return node_core_library_1.Executable.tryResolve('tar');
    }
}
