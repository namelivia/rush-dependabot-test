...
exports.AsyncOperationQueue = void 0;
...
class AsyncOperationQueue {
    ...
    assignOperations() {
        ...
        for (let i = queue.length - 1; waitingIterators.length > 0 && i >= 0; i--) {
            ...
            if (operation.status === OperationStatus_1.OperationStatus.Blocked) {
                // It shouldn't be on the queue, remove it
                queue.splice(i, 1);
            }
            else if (operation.status !== OperationStatus_1.OperationStatus.Ready) {
                // Sanity check
...
exports.AsyncOperationQueue = AsyncOperationQueue;
/**
