...
class RushCommandLineParser extends ts_command_line_1.CommandLineParser {
    ...
    _addPhasedCommandLineConfigAction(commandLineConfiguration, command) {
        ...
        this.addAction(new PhasedScriptAction_1.PhasedScriptAction(Object.assign(Object.assign({}, baseCommandOptions), { enableParallelism: command.enableParallelism, incremental: command.incremental || false, disableBuildCache: command.disableBuildCache || false, initialPhases: command.phases, watchPhases: command.watchPhases, phases: commandLineConfiguration.phases, alwaysWatch: command.alwaysWatch, alwaysInstall: command.alwaysInstall })));
    }
