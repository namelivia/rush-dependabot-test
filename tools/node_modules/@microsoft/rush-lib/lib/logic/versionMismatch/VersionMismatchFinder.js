...
class VersionMismatchFinder {
    ...
    static ensureConsistentVersions(rushConfiguration, options = {}) {
        VersionMismatchFinder._checkForInconsistentVersions(rushConfiguration, Object.assign(Object.assign({}, options), { isRushCheckCommand: false, truncateLongPackageNameLists: true }));
    }
    /**
